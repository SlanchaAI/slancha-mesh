...
> the GitNexus section further down. Humans: `README.md`, `NODE_SETUP.md`.
> Deep design: `docs/SELF_ORGANIZING_LOOP_SCOPE.md`.
...
This project is indexed by GitNexus as **slancha-mesh** (2550 symbols, 7836 relationships, 219 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
