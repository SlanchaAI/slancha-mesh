...
slancha-mesh service install --kind node --env SLANCHA_AUTH_REQUIRED=false -- --specialist code-7b
...
can host several node services. Repeat `--env NAME=VALUE` for non-secret
