...
- [ ] **Step 5: Probe the running router without changing services**
...
```bash
BARKEEP_BIN="uv run --project ../barkeep barkeep" \
python3 ../dotfiles-claude/skills/build-loop/scripts/review.py \
